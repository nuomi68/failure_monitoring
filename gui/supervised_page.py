...
class SupervisedPage(QWidget):
    def __init__(self):
        ...
        for name, spec in [("标准化 (Z‑score)", "standard"),
                           ("MinMax [0,1]", "minmax"), ("Robust (IQR)", "robust"), ("MaxAbs", "maxabs"), ("PowerTransformer", "power"), ("QuantileTransformer", "quantile"), ("Normalizer (L2)", "normalizer"), ("不做缩放", "none")]:
